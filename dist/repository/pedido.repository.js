...
var pedidoRepository = /** @class */ (function () {
    ...
    pedidoRepository.prototype.getall = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typeorm_1.getManager()
                            .getRepository(pedido_1.Pedido)
                            .createQueryBuilder()
                            .getMany()];
    ...
    pedidoRepository.prototype.getfindID = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typeorm_1.getManager()
    ...
    pedidoRepository.prototype.createPedido = function (pedido) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typeorm_1.getManager()
